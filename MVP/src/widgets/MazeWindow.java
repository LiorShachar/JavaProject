...
public class MazeWindow extends WidBasicWindow{
	...
	void initWidgets() {
		...
		///-----------------------------------------------------------------------------------------------
		Button tryButton=new Button(shell, SWT.PUSH);
		tryButton.setText("Start");
		tryButton.setLayoutData(new GridData(SWT.FILL, SWT.None, false, false, 1, 1));
